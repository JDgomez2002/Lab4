 ...
 * @version ClaseA 1.1
 */
public class ClaseA implements Radio {
    ...
    private String ultimo_contacto;
    ...
    public ClaseA(){
        ...
        this.fm_o_am = "FM";
        this.emisora = 1.56;
        this.ultimo_contacto = "Abner: 4515236";
    }
    ...
    public String get_ultimo_contacto(){
        return this.ultimo_contacto;
    }
    ...
    public String[] datos_radio(){
        ...
        s[2] = "Ultimo contacto: "+this.ultimo_contacto;
