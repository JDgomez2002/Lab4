 ...
 * @version ClaseC 1.1
 */
public class ClaseC implements Radio {
    ...
    private String llamar_ultimo_contacto;
    private String pronostico_tiempo;
    ...
    public ClaseC(){
        ...
        this.fm_o_am = "FM";
        this.emisora = 1.56;
        this.llamar_ultimo_contacto = "Abner 45895612";
        this.pronostico_tiempo = "El clima se ve favorable para salir a caminar o correr, soleado con una ligera lluvia.";
    }
    ...
    public String get_llamar_ultimo_contacto(){
        return this.llamar_ultimo_contacto;
    }

    public String get_pronostico_clima(){  
        return this.pronostico_tiempo;
    }
    ...
    public String[] datos_radio(){
        ...
        s[2] = "Ultimo contacto: "+this.pronostico_tiempo;
        s[3] = "Radial: "+this.fm_o_am;
        s[4] = "Ultimo contacto: "+this.llamar_ultimo_contacto;
        return s;
    }
